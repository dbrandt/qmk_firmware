...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------|
     * | LCTRL  | A      | S      | D      | F      | G      | HOME   | PG UP  | H      | J      | K      | L      | ;      | ENTER  |
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------|
	...
	KC_ESC,     SE_1,    SE_2,    SE_3,    SE_4,    SE_5,    SE_MINS, SE_EQL,  SE_6,    SE_7,    SE_8,    SE_9,      SE_0,    KC_BSPC,
        KC_TAB,     SE_Q,    SE_W,    SE_E,    SE_R,    SE_T,    LBRC,    RBRC,    SE_Y,    SE_U,    SE_I,    SE_O,      SE_P,    SE_QUOT,
        KC_LCTL,    SE_A,    SE_S,    SE_D,    SE_F,    SE_G,    KC_HOME, KC_PGUP, SE_H,    SE_J,    SE_K,    SE_L,      SE_SCLN, KC_ENT,
    ...
    [_SHIFT] = LAYOUT_ortho_5x14(
        ...
        KC_TAB,  S(SE_Q), S(SE_W), S(SE_E), S(SE_R), S(SE_T), LCBR,    RCBR,    S(SE_Y), S(SE_U), S(SE_I), S(SE_O), S(SE_P), SE_DQUO,
	KC_LCTL, S(SE_E), S(SE_S), S(SE_D), S(SE_F), S(SE_G), SE_LPRN, SE_RPRN, S(SE_H), S(SE_J), S(SE_K), S(SE_L), SE_COLN, KC_ENT,
    ...
    [_FN] = LAYOUT_ortho_5x14(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, RGB_RMOD, RGB_HUD, RGB_SAD,  RGB_VAD, _______, QK_BOOT,
